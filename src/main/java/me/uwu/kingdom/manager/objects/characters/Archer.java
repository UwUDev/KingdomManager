...
public class Archer extends Character {
    ...
    public Archer(String letterId, int pid, int uid) {
        super(new JsonObject());
        Gson gson = new Gson();
        Random random = new Random();
        this.getData().addProperty("name", "Archer P" + pid + " [" + letterId + "]");
        this.getData().add("parentObject", new ParentObject("").toJsonObject());
        this.getData().addProperty("hierarchyPath", "Level/GameLayer/");
        this.getData().addProperty("prefabPath", "Prefabs/Characters/Archer");
        this.getData().addProperty("uniqueID", "Archer P" + pid + " [" + letterId + "]--" + uid);
        ...
        this.getData().addProperty("decayHint", 2);
        this.getData().addProperty("decayResistanceDays", 2);
        ...
        for (JsonObject jsonObject : gson.fromJson("[{\"name\":\"Wallet\",\"type\":\"WalletData\",\"data\":\"{\\\"coins\\\":0,\\\"gems\\\":0}\"},{\"name\":\"Character\",\"type\":\"CharacterData\",\"data\":\"{\\\"isGrabbed\\\":false,\\\"inert\\\":false}\"},{\"name\":\"Archer\",\"type\":\"ArcherData\",\"data\":\"{\\\"tower\\\":{\\\"linkedObjectID\\\":\\\"\\\"},\\\"knight\\\":{\\\"linkedObjectID\\\":\\\"\\\"},\\\"guardSide\\\":1,\\\"guardDepth\\\":0}\"},{\"name\":\"Damageable\",\"type\":\"DamageableData\",\"data\":\"{\\\"hitPoints\\\":0,\\\"invulnerable\\\":false}\"}]", JsonObject[].class)) {
