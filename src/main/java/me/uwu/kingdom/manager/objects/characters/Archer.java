...
public class Archer extends Obj {
    ...
    public Archer(){
        ...
        this.setName("Archer P" + rdm + " [A]");
        this.setParentObject(new ParentObject(""));
        this.setHierarchyPath("Level/GameLayer/");
        this.setPrefabPath("Prefabs/Characters/Archer");
        this.setUniqueID("Archer P" + rdm + " [A]--" + rdm);
        this.setMode(0);
